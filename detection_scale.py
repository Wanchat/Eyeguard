...
def estimate():
    ...
    while True:
        ...
        for rect in rects:
            ...
            line_AC = cv2.line(frame,(int(point_center_x),240), (int(center_left_x), int(center_left_y)),(255,0,0),1)
            line_AD = cv2.line(frame,(int(point_center_x),240), (int(point_center_x), int(point_center_y)),(255,255,0),1)
            line_BC = cv2.line(frame, (int(center_right_x), int(center_right_y)), (int(center_left_x),int(center_left_y)), (0,255,0), 1)
            ...
            # return estimate_distance, estimate_angle
